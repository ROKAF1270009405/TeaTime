		...
		<ul>
			...
			<li>
				<button type="button" class="gpa">
					<img src="reviewimg/happy.png" id="happy" name="" onclick=change('happy') alt="hi">
				</button>
				<button type="button" class="gpa">
					<img src="reviewimg/surprised.png" id="surprised" name="" onclick=change('surprised') alt="hi">
				</button>
				<button type="button" class="gpa">
					<img src="reviewimg/sad.png" id="sad" name="" onclick=change('sad') alt="hi">
				</button>
				<input id="gpa" name="gpa" value="">
			</li>
